(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const f of document.querySelectorAll('link[rel="modulepreload"]'))n(f);new MutationObserver(f=>{for(const d of f)if(d.type==="childList")for(const r of d.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function i(f){const d={};return f.integrity&&(d.integrity=f.integrity),f.referrerPolicy&&(d.referrerPolicy=f.referrerPolicy),f.crossOrigin==="use-credentials"?d.credentials="include":f.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function n(f){if(f.ep)return;f.ep=!0;const d=i(f);fetch(f.href,d)}})();const M=(s,e,i)=>Math.min(Math.max(s,e),i),U=s=>s*Math.PI/180;let T=1;function $(s){T=M(s,.25,1)}function L(s){const e=Math.max(1,window.devicePixelRatio||1),i=Math.round(s.clientWidth*e*T),n=Math.round(s.clientHeight*e*T);return(s.width!==i||s.height!==n)&&(s.width=i,s.height=n),{width:i,height:n}}function H(s){const e={yaw:0,pitch:U(4.5),radius:18,fovY:Math.PI/3,roll:0,update:r=>{}},i={q:!1,e:!1};window.addEventListener("keydown",r=>{r.key.toLowerCase()==="q"&&(i.q=!0),r.key.toLowerCase()==="e"&&(i.e=!0)}),window.addEventListener("keyup",r=>{r.key.toLowerCase()==="q"&&(i.q=!1),r.key.toLowerCase()==="e"&&(i.e=!1)});let n=!1,f=0,d=0;return s.addEventListener("mousedown",r=>{n=!0,f=r.clientX,d=r.clientY}),window.addEventListener("mouseup",()=>{n=!1}),window.addEventListener("mousemove",r=>{if(!n)return;const u=r.clientX-f,c=r.clientY-d;f=r.clientX,d=r.clientY;const a=.005;e.yaw+=u*a,e.pitch+=c*a;const t=U(89.5);e.pitch=M(e.pitch,-t,t)}),s.addEventListener("wheel",r=>{r.preventDefault(),e.radius*=Math.exp(r.deltaY*.001),e.radius=M(e.radius,2.5,100)},{passive:!1}),e.update=r=>{i.q&&(e.roll-=1*r),i.e&&(e.roll+=1*r)},e}function X(s){const e=Math.cos(s.yaw),i=Math.sin(s.yaw),n=Math.cos(s.pitch),f=Math.sin(s.pitch),d=s.radius,r=[0,0,0],u=[d*i*n,d*f,d*e*n];let c=[r[0]-u[0],r[1]-u[1],r[2]-u[2]];{const l=Math.hypot(c[0],c[1],c[2])||1;c=[c[0]/l,c[1]/l,c[2]/l]}const a=[0,1,0];let t=[a[1]*c[2]-a[2]*c[1],a[2]*c[0]-a[0]*c[2],a[0]*c[1]-a[1]*c[0]];{const l=Math.hypot(t[0],t[1],t[2])||1;t=[t[0]/l,t[1]/l,t[2]/l]}let o=[c[1]*t[2]-c[2]*t[1],c[2]*t[0]-c[0]*t[2],c[0]*t[1]-c[1]*t[0]];{const l=Math.hypot(o[0],o[1],o[2])||1;o=[o[0]/l,o[1]/l,o[2]/l]}if(s.roll!==0){const l=Math.cos(s.roll),h=Math.sin(s.roll),g=[t[0]*l+o[0]*h,t[1]*l+o[1]*h,t[2]*l+o[2]*h],p=[-t[0]*h+o[0]*l,-t[1]*h+o[1]*l,-t[2]*h+o[2]*l];t=g,o=p}return{camPos:u,camFwd:c,camRight:t,camUp:o}}const W=`struct VSOut {
...
`,K=W;class B{element;constructor(e="overlay"){const i=document.getElementById(e);if(!i)throw new Error(`Overlay element with id "${e}" not found`);this.element=i}setText(e){this.element.textContent=e}setError(e){this.element.textContent=`Error: ${e}`,this.element.style.color="#f00"}setInfo(e){this.element.textContent=e,this.element.style.color="#0f0"}setMetrics(e){let i="";const n=(a,t,o="",l="")=>`
        ...
        <div class="overlay-section">
          ...
          ${t}
        </div>`:"";let d="";e.fps!==void 0&&(d+=n("FPS",e.fps.toFixed(1))),e.time!==void 0&&(d+=n("Sim Time",e.time.toFixed(1),"s")),e.resolution&&(d+=n("Res",e.resolution)),e.maxRaySteps!==void 0&&(d+=n("Max Steps",e.maxRaySteps.toString())),i+=f("System",d);let r="";e.fov!==void 0&&(r+=n("FOV",(e.fov*180/Math.PI).toFixed(1),"°")),e.pitch!==void 0&&(r+=n("Pitch",e.pitch.toFixed(1),"°")),e.yaw!==void 0&&(r+=n("Yaw",e.yaw.toFixed(1),"°")),e.roll!==void 0&&(r+=n("Roll",e.roll.toFixed(1),"°")),i+=f("Camera",r);let u="";if(e.distance!==void 0&&(u+=n("Distance",e.distance.toFixed(2),"Rₛ")),e.distanceToHorizon!==void 0){const a=e.distanceToHorizon;let t="";a<.1?t="danger":a<.5&&(t="warning"),u+=n("Dist to Horizon",a.toFixed(3),"Rₛ",t)}i+=f("Position",u);let c="";if(e.metric){let a=e.metric;a==="Schwarzschild"&&(a='<a href="https://jila.colorado.edu/~ajsh/bh/schwp.html" target="_blank" rel="noopener noreferrer">Schwarzschild</a>'),c+=n("Metric",a)}e.orbitalVelocity!==void 0&&(c+=n("Orbital Vel",e.orbitalVelocity.toFixed(3),"c")),e.gForce!==void 0&&(c+=n("Local g",e.gForce.toFixed(3),"c²/Rₛ")),e.timeDilation!==void 0&&(c+=n("Time Dilation",e.timeDilation.toFixed(4))),e.redshift!==void 0&&(isFinite(e.redshift)?c+=n("Redshift z",(e.redshift>=0?"+":"")+e.redshift.toFixed(4)):c+=n("Redshift z","∞")),i+=f("Physics",c),this.element.innerHTML=i,this.element.style.color=""}getElement(){return this.element}}function j(s){const i=new Uint8Array(1048576),n=new Uint8Array(512),f=[151,160,137,91,90,15,131,13,201,95,96,53,194,233,7,225,140,36,103,30,69,142,8,99,37,240,21,10,23,190,6,148,247,120,234,75,0,26,197,62,94,252,219,203,117,35,11,32,57,177,33,88,237,149,56,87,174,20,125,136,171,168,68,175,74,165,71,134,139,48,27,166,77,146,158,231,83,111,229,122,60,211,133,230,220,105,92,41,55,46,245,40,244,102,143,54,65,25,63,161,1,216,80,73,209,76,132,187,208,89,18,169,200,196,135,130,116,188,159,86,164,100,109,198,173,186,3,64,52,217,226,250,124,123,5,202,38,147,118,126,255,82,85,212,207,206,59,227,47,16,58,17,182,189,28,42,223,183,170,213,119,248,152,2,44,154,163,70,221,153,101,155,167,43,172,9,129,22,39,253,19,98,108,110,79,113,224,232,178,185,112,104,218,246,97,228,251,34,242,193,238,210,144,12,191,179,162,241,81,51,145,235,249,14,239,107,49,192,214,31,181,199,106,157,184,84,204,176,115,121,50,45,127,4,150,254,138,236,205,93,222,114,67,29,24,72,243,141,128,195,78,66,215,61,156,180];for(let t=0;t<256;t++)n[256+t]=n[t]=f[t];function d(t){return t*t*t*(t*(t*6-15)+10)}function r(t,o,l){return o+t*(l-o)}function u(t,o,l,h){const g=t&15,p=g<8?o:l,v=g<4?l:g==12||g==14?o:h;return((g&1)==0?p:-p)+((g&2)==0?v:-v)}function c(t,o,l){const h=Math.floor(t)&255,g=Math.floor(o)&255,p=Math.floor(l)&255;t-=Math.floor(t),o-=Math.floor(o),l-=Math.floor(l);const v=d(t),w=d(o),y=d(l),b=n[h]+g,S=n[b]+p,R=n[b+1]+p,m=n[h+1]+g,N=n[m]+p,C=n[m+1]+p;return r(y,r(w,r(v,u(n[S],t,o,l),u(n[N],t-1,o,l)),r(v,u(n[R],t,o-1,l),u(n[C],t-1,o-1,l))),r(w,r(v,u(n[S+1],t,o,l-1),u(n[N+1],t-1,o,l-1)),r(v,u(n[R+1],t,o-1,l-1),u(n[C+1],t-1,o-1,l-1))))}for(let t=0;t<512;t++)for(let o=0;o<512;o++){let h=0,g=.5,p=1;for(let y=0;y<4;y++){const b=o*.05*p,S=t*.05*p;h+=g*c(b,S,0),g*=.5,p*=2}const v=Math.floor((h+1)*.5*255),w=(t*512+o)*4;i[w]=v,i[w+1]=v,i[w+2]=v,i[w+3]=255}const a=s.createTexture({size:[512,512],format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST});return s.queue.writeTexture({texture:a},i,{bytesPerRow:512*4},{width:512,height:512}),a}async function Z(s,e){if(!("gpu"in navigator))throw e.setError("WebGPU not supported in this browser."),new Error("WebGPU not supported in this browser.");const i=await navigator.gpu.requestAdapter();if(!i)throw e.setError("No GPU adapter found."),new Error("No GPU adapter found.");const n=await i.requestDevice();n.addEventListener("uncapturederror",h=>{const p=h.error.message;console.error("WebGPU Uncaptured Error:",p),e.setError(`GPU Error: ${p}`)});const d=n.createBuffer({size:80,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),r=j(n),u=n.createSampler({magFilter:"linear",minFilter:"linear",mipmapFilter:"linear",addressModeU:"repeat",addressModeV:"repeat"}),c=n.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT|GPUShaderStage.VERTEX,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{}},{binding:2,visibility:GPUShaderStage.FRAGMENT,sampler:{}}]}),a=n.createPipelineLayout({bindGroupLayouts:[c]}),t=n.createBindGroup({layout:c,entries:[{binding:0,resource:{buffer:d}},{binding:1,resource:r.createView()},{binding:2,resource:u}]}),o=s.getContext("webgpu");if(!o)throw e.setError("Could not get webgpu context."),new Error("Could not get webgpu context.");const l=navigator.gpu.getPreferredCanvasFormat();return o.configure({device:n,format:l,alphaMode:"opaque"}),{device:n,context:o,uniformBuffer:d,bindGroup:t,pipelineLayout:a,canvasFormat:l}}async function J(s,e,i,n,f){const d=s.createShaderModule({code:K}),r=await d.getCompilationInfo();if(r.messages.length>0){let u=!1;for(const c of r.messages)console.log(`Shader ${c.type}: ${c.message} at line ${c.lineNum}`),c.type==="error"&&(u=!0);if(u)throw new Error("Shader compilation failed. Check console for details.")}return s.createRenderPipeline({layout:e,vertex:{module:d,entryPoint:"vs_main"},fragment:{module:d,entryPoint:"fs_main",targets:[{format:i}]},primitive:{topology:"triangle-list"}})}let D=1e3,q=1,G=!1;function Q(s){q=Math.min(2,Math.max(.5,s))}function ee(s){G=s}async function te(s,e,i,n){L(s);const f=await J(i.device,i.pipelineLayout,i.canvasFormat);let d=performance.now(),r=0;const u=[],c=30,a=2,t=6;function o(){const l=performance.now(),h=(l-d)/1e3;d=l,u.push(h),u.length>c&&u.shift(),r=1/(u.reduce((x,k)=>x+k,0)/u.length),n.update(h);const{camPos:p,camFwd:v,camRight:w,camUp:y}=X(n),{width:b,height:S}=L(s),R=performance.now()/1e3,m=Math.hypot(p[0],p[1],p[2]),C=(m-a)/a,_=m>1.5*a?Math.sqrt(a/(2*m)):0;let P=0;if(m>a){const x=2*m*m*Math.sqrt(1-a/m);x>1e-4?P=a/x:P=1/0}else P=1/0;let I=0;m>a?I=Math.sqrt(1-a/m):m>0&&(I=0);let F=1/0;if(m>a&&t>a){const x=1-a/m,k=1-a/t;x>0&&(F=Math.sqrt(x/k)-1)}else m<=a&&(F=1/0);e.setMetrics({resolution:`${b}x${S}`,pitch:n.pitch*180/Math.PI,yaw:n.yaw*180/Math.PI,roll:n.roll*180/Math.PI,distance:m/a,time:R,distanceToHorizon:C,orbitalVelocity:_,gForce:P,fov:n.fovY,maxRaySteps:D,fps:r,timeDilation:I,redshift:F,metric:"Schwarzschild"});const V=new Float32Array([b,S,R,n.fovY,p[0],p[1],p[2],0,v[0],v[1],v[2],D,w[0],w[1],w[2],q,y[0],y[1],y[2],G?1:0]);i.device.queue.writeBuffer(i.uniformBuffer,0,V);const z=i.device.createCommandEncoder(),Y=i.context.getCurrentTexture().createView(),E=z.beginRenderPass({colorAttachments:[{view:Y,loadOp:"clear",storeOp:"store",clearValue:{r:0,g:0,b:0,a:1}}]});E.setPipeline(f),E.setBindGroup(0,i.bindGroup),E.draw(3,1,0,0),E.end(),i.device.queue.submit([z.finish()]),requestAnimationFrame(o)}requestAnimationFrame(o)}async function O(){const s=document.getElementById("gpu-canvas");if(!s)throw new Error("gpu-canvas not found");const e=new B;e.setText("Initializing...");const i=document.getElementById("render-scale"),n=document.getElementById("render-scale-value");if(i&&n){const a=o=>{Number.isFinite(o)&&($(o),n.textContent=`${Math.round(o*100)}%`)},t=Number(i.value||"1");a(t),i.addEventListener("input",o=>{const l=o.target,h=Number(l.value);a(h)})}const f=document.getElementById("step-scale"),d=document.getElementById("step-scale-value");if(f&&d){const a=o=>{Number.isFinite(o)&&(Q(o),d.textContent=`${o.toFixed(1)}×`)},t=Number(f.value||"1");a(t),f.addEventListener("input",o=>{const l=o.target,h=Number(l.value);a(h)})}const r=document.getElementById("use-noise-texture");r&&r.addEventListener("change",a=>{const t=a.target;ee(t.checked)});const u=H(s),c=await Z(s,e);await te(s,e,c,u)}function A(s){console.error("Initialization error:",s);try{const e=new B,i=s instanceof Error?s.message:String(s);e.setError(`Init error: ${i}`)}catch{console.error("Failed to create overlay for error display")}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{O().catch(A)}):O().catch(A);
