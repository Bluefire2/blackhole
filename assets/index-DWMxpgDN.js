(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const t of r)if(t.type==="childList")for(const c of t.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&o(c)}).observe(document,{childList:!0,subtree:!0});function i(r){const t={};return r.integrity&&(t.integrity=r.integrity),r.referrerPolicy&&(t.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?t.credentials="include":r.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function o(r){if(r.ep)return;r.ep=!0;const t=i(r);fetch(r.href,t)}})();const E=(n,e,i)=>Math.min(Math.max(n,e),i),T=n=>n*Math.PI/180;let N=1;function V(n){N=E(n,.25,1)}function D(n){const e=Math.max(1,window.devicePixelRatio||1),i=Math.round(n.clientWidth*e*N),o=Math.round(n.clientHeight*e*N);return(n.width!==i||n.height!==o)&&(n.width=i,n.height=o),{width:i,height:o}}function X(n){const e={yaw:0,pitch:T(4.5),radius:18,fovY:Math.PI/3};let i=!1,o=0,r=0;return n.addEventListener("mousedown",t=>{i=!0,o=t.clientX,r=t.clientY}),window.addEventListener("mouseup",()=>{i=!1}),window.addEventListener("mousemove",t=>{if(!i)return;const c=t.clientX-o,f=t.clientY-r;o=t.clientX,r=t.clientY;const a=.005;e.yaw+=c*a,e.pitch+=f*a;const l=T(89.5);e.pitch=E(e.pitch,-l,l)}),n.addEventListener("wheel",t=>{t.preventDefault(),e.radius*=Math.exp(t.deltaY*.001),e.radius=E(e.radius,2.5,100)},{passive:!1}),e}function W(n){const e=Math.cos(n.yaw),i=Math.sin(n.yaw),o=Math.cos(n.pitch),r=Math.sin(n.pitch),t=n.radius,c=[0,0,0],f=[t*i*o,t*r,t*e*o];let a=[c[0]-f[0],c[1]-f[1],c[2]-f[2]];{const d=Math.hypot(a[0],a[1],a[2])||1;a=[a[0]/d,a[1]/d,a[2]/d]}const l=[0,1,0];let s=[l[1]*a[2]-l[2]*a[1],l[2]*a[0]-l[0]*a[2],l[0]*a[1]-l[1]*a[0]];{const d=Math.hypot(s[0],s[1],s[2])||1;s=[s[0]/d,s[1]/d,s[2]/d]}let h=[a[1]*s[2]-a[2]*s[1],a[2]*s[0]-a[0]*s[2],a[0]*s[1]-a[1]*s[0]];{const d=Math.hypot(h[0],h[1],h[2])||1;h=[h[0]/d,h[1]/d,h[2]/d]}return{camPos:f,camFwd:a,camRight:s,camUp:h}}const j=`struct VSOut {
